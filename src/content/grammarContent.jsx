  ...
  window.App.Content.GRAMMAR_ITEMS = {
    mixed: {
      easy: [
        ...
        { id: "gm-easy-8", type: "fillblank", sentence: "My family ___ going on vacation next week.", options: ["is", "are", "were", "have"], correctIndex: 0, explanation: "Collective nouns like \"family,\" \"team,\" and \"class\" usually take a singular verb when acting as one unit. For example: \"The team is practicing every day this week.\"" },
      ],
      medium: [
        { id: "gm-medium-1", type: "fillblank", sentence: "If I were you, I ___ apologize right away.", options: ["would", "will", "was going to", "am going to"], correctIndex: 0, explanation: "The second conditional (If + past, ... would) is used for hypothetical advice. For example: \"If I were rich, I would travel the world.\"" },
      ...
      hard: [
        ...
        { id: "gm-hard-5", type: "fillblank", sentence: "Not only ___ the plan save money, but it also saved time.", options: ["did", "does", "was", "has"], correctIndex: 0, explanation: "\"Not only\" at the start of a sentence triggers inversion; with a past action, use \"did + base verb.\" For example: \"Not only did he apologize, he also fixed the mistake.\"" },
    ...
    tense: {
      ...
      expert: [
        ...
        { id: "gt-expert-2", type: "fillblank", sentence: "It's high time we ___ this issue.", options: ["addressed", "address", "are addressing", "will address"], correctIndex: 0, explanation: "\"It's (high) time\" + subject uses a past tense form to express something that should happen now. For example: \"It's about time you apologized.\"" },
        { id: "gt-expert-3", type: "fillblank", sentence: "Not until the results were announced ___ how close the race had been.", options: ["did we realize", "we realized", "we did realize", "did we realized"], correctIndex: 0, explanation: "Negative time expressions like \"not until\" at the start trigger subject-auxiliary inversion. For example: \"Not until she spoke did I recognize her voice.\"" },
    ...
    preposition: {
      ...
      medium: [
        ...
        { id: "gp-medium-3", type: "fillblank", sentence: "She apologized ___ being late.", options: ["for", "to", "about", "of"], correctIndex: 0, explanation: "\"Apologize for\" is the standard collocation for the reason behind an apology. For example: \"He apologized for the mess.\"" },
        ...
        items: [
          {
            ...
            options: ["was practicing", "practiced", "has practiced", "practices"],
            correctIndex: 0,
            explanation: "Past continuous shows an action in progress when it was interrupted by another past event (\"arrived\").",
          },
          {
            sentence: "Aiden was practicing free throws when his coach arrived. By the end of practice, he ___ over fifty shots in a row.",
