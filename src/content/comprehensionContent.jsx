  ...
  window.App.Content.COMPREHENSION_ITEMS = {
    easy: [
        ...
        questions: [
          {
            ...
            options: ["Things everyone is expected to know even though nobody wrote them down", "Rules that the school forgot to print in the student handbook by mistake", "Rules that only the teachers know and are not allowed to tell the pupils"],
            correctIndex: 0,
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "What do the thin cracks in the mended vase suggest?", options: ["They are a reminder of the mistake and of how honestly it was handled", "They show that the glue they had chosen was not strong enough to hold it", "They show that Leo did not take enough care when he glued the vase back"], correctIndex: 0, explanation: "The cracks \"showed where it had broken\", so they quietly record the accident and how Leo dealt with it. The passage never says the glue was weak or that Leo was careless." },
        ],
      },
      {
        id: "comp-easy-4",
      ...
      },
      {
        ...
        questions: [
          { type: "mc", prompt: "Why did Ivy stay beside the biscuits?", options: ["She remembered her dad's advice about what to do if she got lost", "She was too scared to walk any further down the long aisle alone", "She wanted to choose a packet of biscuits to buy with her money"], correctIndex: 0, explanation: "She wanted to run and shout, but she remembered Dad's rule: stay where you are and find someone who works there. Staying put was a choice, not just fear." },
      ...
      },
      {
        ...
        questions: [
          { type: "mc", prompt: "Why do puddles disappear faster on a hot, windy day?", options: ["Heat and moving air help the water turn into vapour more quickly", "The wind blows the puddle water away into the nearest drains", "Hot weather makes the dry ground soak up much more of the water"], correctIndex: 0, explanation: "The passage says heat and moving air help the water to evaporate quickly. The playground is hard, so the ground cannot soak the water up." },
          ...
          { type: "mc", prompt: "Which sentence about water vapour is TRUE?", options: ["It is invisible, and it later turns into drops that form clouds", "It is clearly visible as it rises from the puddle into the sky", "It forms when water is cooled down until it becomes a solid block"], correctIndex: 0, explanation: "The passage says vapour is invisible and later cools into tiny drops that form clouds. Vapour is made by heating water, not by cooling it into a solid." },
        ],
      },
      {
        id: "comp-easy-8",
        ...
        questions: [
          { type: "mc", prompt: "What can we infer about how Zoe felt when she forgot her lines?", options: ["Frightened and embarrassed in front of everyone", "Angry with Max for not helping her much sooner", "Bored because she had practised so many times"], correctIndex: 0, explanation: "Her mind went blank, her hands shook, and the audience waited. That points to fear and embarrassment. Nothing suggests she was angry or bored." },
    ...
    medium: [
        ...
        questions: [
          {
            ...
            options: ["The arm closed so quickly that it knocked the blocks off balance before lifting", "The blocks were too heavy to be gripped quickly, so the arm needed more time", "The gripper had been rebuilt so many times that its parts had finally worn out"],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "He rebuilt the gripper four times in the weeks before the competition",
              "He stayed late in the workshop on Wednesday night to run more tests",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              "Devon and Marcus practised a similar amount, but Devon worked on specific weaknesses",
          ...
          },
          {
            ...
            options: [
              ...
              "It was correct, because Devon had clearly practised far longer than Marcus had every week",
              "It was correct, although hard work can sometimes help players to make up for a lack of talent",
            ],
            correctIndex: 0,
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "What can be inferred about how most octopuses learn?", options: ["Mainly from their own experience, without help from parents", "By copying the older octopuses that live in the nearby caves", "By being taught in small groups when they are very young"], correctIndex: 0, explanation: "Because many octopuses live one or two years and never meet their parents, each one must \"discover the world for itself\"." },
    ...
    hard: [
        ...
        questions: [
          {
            ...
            options: [
              "Kai focused on students who need phones, while supporters focused on distraction and anxiety",
              "Kai believed phones help students concentrate in class, while supporters disagreed with that",
        ...
        questions: [
          {
            ...
            options: ["How much responsibility different types of participation deserved", "Whether the screenshot should ever have been shared around school", "Whether the jokes in the group chat had really been unkind at all"],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: ["What it would have taken for one person to change the conversation's direction", "Who had written the very first unkind message in the whole private group chat", "Whether the classmate who was mocked should forgive the whole group afterwards"],
            correctIndex: 0,
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "Which statement is supported by the passage?", options: ["Greenwich became the world's reference point in 1884, but not every country adopted it at once", "Britain accepted a national time standard in 1840, and all other countries copied it at once", "France helped to choose Greenwich as the starting point in 1884 and used it straight away"], correctIndex: 0, explanation: "Greenwich was agreed in 1884, but the passage says France kept its own system for years. Britain's law recognised a single standard only by 1880." },
        ],
      },
      {
        id: "comp-hard-5",
        ...
        questions: [
          { type: "mc", prompt: "Why does the writer mention the experiment with extra oxygen?", options: ["To show that a popular explanation was tested and did not hold up", "To prove once and for all that yawning has no purpose in the body", "To explain why people yawn far more often in rooms with fresh air"], correctIndex: 0, explanation: "People breathing extra oxygen yawned just as often, so the oxygen theory was weakened. It does not prove that yawning has no purpose." },
          ...
          { type: "mc", prompt: "Why does the writer put the word \"catch\" in quotation marks?", options: ["Yawns are not caught like an illness, but they seem to pass between people", "The word is a direct quotation taken from one of the scientists mentioned", "Yawns can only be caught from people whom we already know very well"], correctIndex: 0, explanation: "The word is used figuratively. A yawn is not a disease, but it seems to spread from one person to another." },
        ],
      },
      {
        id: "comp-hard-6",
        ...
        questions: [
          { type: "mc", prompt: "Why did some scientists argue that fear, as well as hunting, changed the elk's behaviour?", options: ["Elk seemed to avoid open river valleys where wolves could ambush them", "Elk began to move away into Canada soon after the wolves were released", "Elk stopped eating willow and aspen because the wolves ate them first"], correctIndex: 0, explanation: "The passage says the elk avoided open valleys where they were easy to ambush. That is a change in behaviour beyond simply being killed." },
          { type: "mc", prompt: "What does \"later research urged caution\" suggest?", options: ["The wolves' effect might be smaller or less certain than first claimed", "Wolves should not have been brought back to Yellowstone in the first place", "The willows and aspen had recovered completely in every part of the park"], correctIndex: 0, explanation: "Later studies pointed to other causes, such as hunting, bears, cougars and rainfall, and to patchy recovery. This does not mean the wolves were a mistake." },
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "Which detail best supports the claim that the Flop was an efficient technique?", options: ["The body's centre of gravity could pass under the bar as the body went over", "The Flop was invented by a young student who had never studied high jumping", "The Flop was first used in a big competition in front of a very large crowd"], correctIndex: 0, explanation: "This detail explains how the technique works: the jumper clears the bar with less energy wasted in lifting the body's centre of gravity." },
        ],
      },
      {
        id: "comp-hard-8",
        ...
        questions: [
          { type: "mc", prompt: "Why did the team scan trainees before and after their training?", options: ["To check whether the training itself caused the brain to change", "To find out in advance which candidates would pass the final exam", "To measure how many streets each trainee could remember by heart"], correctIndex: 0, explanation: "The first study could not show cause and effect: drivers might simply have larger hippocampi already. Scanning before and after shows whether the change came with the training." },
    ...
    expert: [
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Beginners are never involved in financial bubbles, only very experienced professionals",
              "Experienced investors always sell just before a crash begins and so lose no money at all",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Being right too early costs almost as much as being wrong, so there is little reason to warn early",
              "Economists' warnings are usually accurate but too complicated for most ordinary investors to follow",
        ...
        questions: [
          {
            ...
            options: ["Many well-known studies failed to produce the same results when independently repeated", "Many well-known studies were found to contain data that some researchers had invented", "Psychologists could not agree on which of the studies were important enough to repeat"],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: ["It might discourage bold, exploratory research that leads to breakthroughs", "It lets researchers freely change their analysis after seeing the results", "It makes journals publish many more null results, which readers find dull"],
            correctIndex: 0,
      ...
      },
      {
        ...
        questions: [
          { type: "mc", prompt: "Which weakness in Hardin's argument did Ostrom's research expose?", options: ["It assumed that the users could never agree on rules for sharing fairly", "It assumed that shared pastures always give more food than private ones", "It assumed that governments are always better at managing resources"], correctIndex: 0, explanation: "Ostrom found real communities that made and enforced their own rules. Hardin's logic left no room for that." },
      ...
      },
      {
        ...
        questions: [
          { type: "mc", prompt: "Why did Wald say that armour should go where the returning planes had no holes?", options: ["Planes hit in those spots probably never came back, so they were not in the data", "Those areas were the heaviest parts of the plane and needed extra protection", "Enemy gunners mostly aimed at those areas, but their shots were not recorded"], correctIndex: 0, explanation: "The sample contained only survivors. Planes hit in the engines were less likely to return, so the unmarked areas showed where a hit was fatal." },
          { type: "mc", prompt: "What does the example of billionaire dropouts show?", options: ["Stories of success can hide the many people who tried the same thing and failed", "Leaving university early is always a wise decision for talented young people", "Most billionaires became rich mainly because they left university very early"], correctIndex: 0, explanation: "We hear about the few who succeeded and not about the larger number who failed, which can make the risk look safer than it is." },
      ...
      },
      {
        ...
        questions: [
          { type: "mc", prompt: "Why does the writer call the truth \"less dramatic and more instructive\"?", options: ["A slow decline teaches us something about neglect that a single fire does not", "The real story contains far fewer facts than the popular story usually does", "The true story is far too dull for anyone to want to read about it at all"], correctIndex: 0, explanation: "The writer says the gradual decline carries a warning: knowledge disappears when societies stop supporting it. That is the instructive part." },
          { type: "mc", prompt: "What can be inferred about the library after the fire of 48 BCE?", options: ["It continued to operate, since scholars still worked there later", "It was never rebuilt, and its whole collection was lost forever", "It was moved to another city by the Ptolemies almost straight away"], correctIndex: 0, explanation: "The passage says the library carried on and scholars worked there for centuries. The fire damaged only part of the collection." },
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "What does the last sentence suggest?", options: ["Those who set defaults must use their influence carefully and fairly", "People should never trust any choice that is set as a default option", "Defaults are far too weak to affect what most people actually decide"], correctIndex: 0, explanation: "Because defaults are powerful, the people setting them have a responsibility. The passage shows that they strongly affect decisions." },
        ],
      },
      {
        id: "comp-expert-7",
        ...
        questions: [
          ...
          { type: "mc", prompt: "Which harm from artificial light is NOT mentioned in the passage?", options: ["Damage to the eyesight of people who work at night", "Confusion of the many birds that migrate after dark", "Disturbed human sleep because of lowered melatonin"], correctIndex: 0, explanation: "Migrating birds and melatonin are both mentioned. Nothing is said about people's eyesight." },
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "How does the writer treat the two explanations for choking?", options: ["As ideas that may both be true and can work together", "As rival theories, of which only one can be correct", "As unproven ideas that athletes should simply ignore"], correctIndex: 0, explanation: "The writer says the two ideas \"need not conflict\", which means both could play a part in choking." },
        ],
      },
    ],
  };
