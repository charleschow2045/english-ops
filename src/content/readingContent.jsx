    ...
    easy: [
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "What is Lily's favourite job on the farm?", options: ["Brushing the grey pony", "Picking tomatoes", "Feeding chickens"], correctIndex: 0, explanation: "The passage directly says her favourite job is brushing the old grey pony." },
        ],
      },
      {
        id: "read-easy-2",
        ...
        questions: [
          ...
          { type: "mc", prompt: "How did the students feel by the end of the afternoon?", options: ["They had a lot of fun", "They were bored", "They were angry"], correctIndex: 0, explanation: "The passage says the classroom was filled with laughter and several called it a favourite day." },
        ],
      },
    ],
    medium: [
      ...
      },
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "How did the garden affect the neighbours' relationships?", options: ["It brought neighbours together who barely knew each other before", "It caused arguments between neighbours", "It had no effect on the neighbourhood"], correctIndex: 0, explanation: "The bench became a place where neighbours who barely knew each other started to chat." },
        ],
      },
    ],
    hard: [
    ...
    expert: [
      {
        ...
        questions: [
          ...
          { type: "mc", prompt: "What argument do manufacturers give in favour of the practice?", options: ["It allows for continuous innovation and improvement", "It reduces the cost of products", "It is required by law"], correctIndex: 0, explanation: "Manufacturers argue shorter product cycles allow for continuous innovation." },
        ],
      },
      {
        id: "read-expert-2",
        ...
        questions: [
          ...
          { type: "mc", prompt: "What complicates research into the attention economy's effects, according to the passage?", options: ["The companies best positioned to study it have a business interest in the behaviours being studied", "There is no way to measure user attention at all", "Governments have banned this kind of research"], correctIndex: 0, explanation: "The passage says the companies best positioned to study it depend on the very behaviours being studied." },
        ],
      },
    ],
  };
