        ...
        questions: [
          {
            ...
            options: [
              ...
              "Ben gives the kitten a soft blanket and a bowl of warm milk that night",
              "Ben hears a soft, shaky meow while he is walking home from school",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "He made posters with the kitten's photo and put them up around the neighbourhood",
              "He asked his teacher to make an announcement about the kitten to the whole school",
              "He waited outside the bush for many hours in case the owner came back for it",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "Loud and cheerful, like you are at a big birthday party",
              "Flat and bored, with no expression on your face at all",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "A car horn honking again and again from the street outside",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "The votes are counted and Carlos's spotted gecko wins by three votes",
          ...
          },
          {
            ...
            options: [
              "Slow down, drop your voice, and pause before saying the next sentence",
              "Read faster and faster so that you can get to the happy ending sooner",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Grey clouds cover the sky and hide the sun on Saturday morning",
              "Lily decides that it was the best picnic that they had ever had",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Tap your fingers softly on the table, then faster as the rain grows heavier",
              "Clap your hands loudly three times, then wait quietly until the scene is over",
              "Stay perfectly still and completely silent for the whole of the rainy scene",
            ],
            correctIndex: 0,
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              "Make a rising \"whoosh\" and a sad \"thud\" each time, so listeners can join in",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "The dolphin book is due on Friday and Nora cannot find it anywhere",
              "Miss Chan says that the scribble can be rubbed away with an eraser",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "She asked her mum to buy a new copy of the dolphin book that weekend",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "In a quiet, steady voice, looking at Miss Chan, with a nervous gulp",
              "In a very loud, cheerful voice while looking up at the high ceiling",
              "In a fast mumble while hiding the book behind her back and blushing",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "Announce that she finds the book under the plastic dinosaur before you begin the scene",
              "Read the toy box line quickly and quietly while you keep looking down at the floor",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Omar's friends laugh loudly because Turbo hides inside his shell",
              "Omar notices that the board around Turbo is much too dry for him",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "Speak as fast as you can so that the story does not drag on and bore them",
              "Clap a quick, lively beat to show that Turbo is racing along the long board",
            ],
            correctIndex: 0,
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              "He made the eruption of the volcano much smaller",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Pause, lean in, look at the audience, then say the line with a \"whoosh\"",
              "Say the result at the very start of the story so that no one is surprised",
              "Read the line quickly and flatly without looking up at the audience once",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              "Coach Reyes asks each player what they need and builds drills around the answers",
              "Coach Diaz breaks his ankle two weeks before the big championship game begins",
              "The team wins 3-1 and Jonah admits that he had misjudged her on the first day",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "In a lower, slower voice, looking down for a moment, with a half-smile",
          ...
          },
          {
            ...
            options: [
              "Pause and ask them what they would think of a quiet new coach, looking around the room",
              "Tell them that they must not say a word or ask any question until you have finished",
              "Skip the part about the first practice so that they don't have to think about it",
            ],
            correctIndex: 0,
        ...
        questions: [
          ...
          },
          {
            ...
            options: [
              ...
              "Sharply and quickly, as if you were giving Mei a firm order to follow",
              "Quietly and sadly, while looking out at the empty street below her",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Stop in mid-sentence, drop to a whisper, and pause before you go on",
              "Speak louder and faster so that the scene stays as exciting as possible",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "He realises that the bus is going in the wrong direction entirely",
          ...
          },
          {
            ...
            options: [
              ...
              "He stayed on the bus until it reached the last stop of the whole route",
              "He called his coach to say that he could not play in the big match",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "Grin, wave both arms wildly, and speak in a loud, cheerful voice",
              "Yawn and slouch, speaking in a calm, slow and rather sleepy voice",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Say the countdown aloud, \"twenty-five minutes... twenty...\", and speed up",
              "Keep the same slow and steady pace all the way through the whole story",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "The judge says \"Correct\" and the whole audience claps loudly for her",
              "Ms Park hands Zara a certificate for sportsmanship after the bee",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "She was sure that the judge would find the mistake later on anyway",
              "She wanted the other competitor to feel very sorry for her afterwards",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Clearly and steadily, though your voice trembles, looking at the judge",
          ...
          },
          {
            ...
            options: [
              "Stop speaking, look slowly around at your audience, and hold the silence",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Mr Lau tells them that their bus has broken down that morning",
          ...
          },
          {
            ...
            options: [
              ...
              "Cheer in a high, bright voice and clap your hands together happily",
              "Speak in a bored, flat monotone without moving your body at all",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "Use a guide's voice, point to imaginary exhibits, and say \"step closer\"",
              "Read the whole list of exhibits very quickly without looking up at anyone",
        ...
        questions: [
          {
            ...
            options: [
              ...
              "The single working lightbulb flickers ominously every few minutes",
              "Sunlight streams through the salt-streaked windows the next morning",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "He showed her how thick and strong the old lighthouse walls were",
              "He promised her that the first ferry would be back within the hour",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Devon accuses the others of not valuing creativity or imagination at all",
              "The four students start sketching their plans for the whole project together",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "The skit used the ship model as a prop, so both ideas worked and the research was covered",
              "Each student did their favourite idea separately and they presented them one after another",
              "They dropped both of their ideas and wrote a plain, simple report about trade instead",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              "Ken pauses and chooses to explain the meaning, not translate word for word",
              "Mr Hall explains that he wants to buy some tea for his wife, who is unwell",
              "Mr Hall buys two tins of tea and says that Ken explained it very well indeed",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Yuki's team wins the semi-final of the school debate by a single point",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "The sun comes out fully and far more runners arrive than the team expected",
              "The supply truck finally arrives after being stuck in traffic for an hour",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "She made the small supply go further by using less per runner and the runners' own bottles",
              "She told the runners to walk on to the next station, which was sure to have more water",
              "She asked the team leader to stop the whole race until the truck arrived with more cups",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "She finds the recipe in an old shoebox at the very back of the wardrobe",
              "She writes her own line beside her great-grandmother's faded handwriting",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "She tried three times with the same batter and had the family taste them blind",
              "She chose the time that her aunt and uncle both agreed on when she asked them",
              "She asked her mother to try hard to remember the exact number from long ago",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              "It has a clear beginning and middle, but deliberately leaves the ending open",
              "It has no beginning, because the manuscript is already old when the story starts",
              "It ends by confirming that Elias's invention was real and that it worked well",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "They studied the sketches and notes to infer what he was building, while admitting there was no proof",
              "They built a working copy of the mysterious device from Elias's sketches and tested it in a laboratory",
              "They matched Elias's handwriting to a patent application that he had filed shortly before he vanished",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Her supervisor dismisses the defect as within acceptable tolerance and moves on",
              "The batch is pulled for additional testing and later turns out to pass safely",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "She weighed the cost of being wrong against the cost of silence, then told the plant's safety officer",
              "She went straight to the client and warned them about the defect before the shipment was sent out",
              "She refused to work on the batch any further until the whole shipment had been recalled by the company",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "There is no real turning point, because nothing changes after the letter arrives",
              "The ending confirms that the two have been reunited and the old quarrel forgotten",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              "It showed that the silence was an accident of the post and that he had reached out",
              "It proved that Henry had never really been sorry about the quarrel they had had",
              "It explained that Mrs Chan had been the one who had started the argument first",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            prompt: "Which part of the story is its climax, the moment the main character makes the key decision?",
            options: [
              "Daniel decides not to publish or hide the diary, and proposes an exhibition",
              "He finds the diary while he is sorting old boxes at the small town museum",
          ...
          },
          {
            ...
            options: [
              "It kept the town's tradition and the truth together, instead of giving up one of them",
              "It let the committee decide in private without needing to explain any of their reasons",
              "It kept the diary hidden in a way that protected the feelings of all the townspeople",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "A customer brings in a tall wooden clock that loses ten minutes each day",
              "Sun slides a folded card under one foot and the ticking finally evens out",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "By replacing the old gears with new ones from the shelves in the shop",
              "By asking the customer to describe how the clock had been used and moved",
            ],
            correctIndex: 0,
        ...
        questions: [
          {
            ...
            options: [
              ...
              "Arguments break out at the well each morning between many of the families",
              "The water level finally stops falling after the first week of the new system",
            ],
            correctIndex: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "It closed the well completely until the next rains came, so that it could refill",
              "It asked each family to bring their water from a river that was much further away",
            ],
            correctIndex: 0,
